...
FocusScope {
    ...
    Connections {
        ...
        function onErrorOccurred(msg) {
            ...
            console.log("[Emby Items] Error: " + msg)
        }
    }
    ...
    Component.onCompleted: {
        if (mode === "static") {
            ...
            isLoading = true
            errorMessage = ""
            embyBackend.load_folder_children(parentId)
        } else if (mode === "boxset") {
            isLoading = true
            errorMessage = ""
            embyBackend.load_boxset_children(parentId)
        } else if (mode === "resume") {
            isLoading = true
            errorMessage = ""
            ...
            isLoading = true
            errorMessage = ""
            embyBackend.load_up_next()
        } else {
            isLoading = true
            errorMessage = ""
            embyBackend.load_items(parentId, includeTypes, "SortName")
        }
    }
